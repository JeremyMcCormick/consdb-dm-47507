...
Revision ID: 5518d5d8a8d4
Revises: e9fd2cdb9c12
Create Date: 2024-12-02 19:48:38.819539+00:00
...
def downgrade() -> None:
    ...
    op.drop_column("ccdvisit1_quicklook", "dummy_column30", schema="cdb_latiss")
