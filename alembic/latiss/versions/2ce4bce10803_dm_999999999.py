...
Revision ID: 2ce4bce10803
Revises: e9fd2cdb9c12
Create Date: 2024-11-26 00:41:01.222534+00:00
...
def downgrade() -> None:
    ...
    op.drop_column("ccdvisit1_quicklook", "dummy_column21", schema="cdb_latiss")
